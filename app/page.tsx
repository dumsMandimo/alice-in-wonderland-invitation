...
import SketchfabBackground from "./components/3drender";
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen">
        {!opened ? (
          <motion.div
            ...
            className="bg-white/60 rounded-2xl shadow-2xl p-10 text-center max-w-md backdrop-blur-md"
          >
            <h1 className="font-serif text-3xl mb-4">
              Follow the White Rabbit 🐇
            </h1>
            <p className="mb-6 italic text-gray-600">
              Click to fall down the rabbit hole
            </p>
            <button
          ...
          <motion.section
            ...
            className="bg-white/60 rounded-3xl shadow-2xl p-12 max-w-lg text-center relative backdrop-blur-md"
          >
            <motion.div
              animate={{ rotate: 360 }}
            ...
            <p className="italic text-teal-700 mb-6">
              A curious and curiouser Celebration
            </p>
